...
public class VerifyCourseResumeFromWhereLeft extends BaseTest
{
	//SUN-1621
	@Test(priority=1, groups={"coursepage","regression1"})
	public void verifyCourseResumeFromWhereLeft() throws Exception
	{
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "Executing Test Case SUN-1621");
		...
		coursePageObj.createCourseForOpenBatchWithFourResourcesFromDifferentContributors(objListOFTestDataForSunbird);
		...
		coursePageObj.resumeTheCourseAfterStopingTheconsumption();
