...
public class ApplyFilterInTeachingMaterialSectionInLibraryPage extends BaseTest

{

	@Test(groups= {"publicuser","sanity1","regression2"})
	public void applyFilterInTeachingMaterialSectionInLibraryPage() throws Exception
	{
		...
		libraryPage.filterInTeachingMaterialSection("TeacherMaterial");
	}
