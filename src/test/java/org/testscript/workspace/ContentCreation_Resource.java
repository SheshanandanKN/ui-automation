...
public class ContentCreation_Resource extends BaseTest{
	
	@Test(groups= {"regression2"})
	public void contentCreation_Resource() throws Exception{
		...
		bookEditorPageObj.editAndSaveResourceForCreatedFor();
